        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-6 pb-12 border-b border-jh-green-900/80">
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-xs text-jh-earth-300 leading-relaxed max-w-sm">
              Building a collaborative platform where citizens, universities and
              industries work together for a greener, stronger and prosperous
              Jharkhand.
            </p>
            <div className="flex items-center gap-3 pt-2">
              <a
                href="#twitter"
                className="w-8 h-8 rounded-lg bg-jh-green-900 flex items-center justify-center text-jh-earth-200 hover:bg-jh-terracotta-600 hover:text-white transition-all shadow-xs"
                title="X (Twitter)"
              >
              ...
              >
                <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.762-2.238 5-5 5h14c2.762 0 5-2.238 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                </svg>
              </a>
            </div>
          </div>
          <div className="lg:col-span-2 space-y-3">
            <h4 className="text-xs font-bold uppercase tracking-wider text-jh-gold-400">
              Quick Links
            </h4>
          ...
          <div className="lg:col-span-4 space-y-3">
            ...
            <p className="text-xs text-jh-earth-300 leading-relaxed max-w-sm">
              SamadhanSetu connects citizens, universities, faculty, government
              stakeholders and industry to report issues, develop solutions and
              track progress.
            </p>
          </div>
        </div>
