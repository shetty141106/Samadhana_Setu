...
export const Modal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/60 backdrop-blur-xs flex items-center justify-center p-4 sm:p-6 animate-in fade-in duration-200">
      ...
      <div
        className={`relative bg-white rounded-2xl shadow-2xl border border-jh-earth-200 w-full ${maxWidth} overflow-hidden z-10 my-8 transition-all transform`}
      >
        ...
        <div className="px-6 py-4 border-b border-jh-earth-200 bg-jh-earth-50 flex items-center justify-between">
          <div>
            ...
            {subtitle && (
              <p className="text-xs text-jh-earth-700 mt-0.5">{subtitle}</p>
            )}
          </div>
          <button
            onClick={onClose}
