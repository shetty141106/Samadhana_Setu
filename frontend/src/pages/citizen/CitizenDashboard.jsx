        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-jh-earth-600">
              Track real-time field verification, university research, and CSR
              resolution progress
            </p>
          </div>
          <Button
        ...
        <div className="bg-white rounded-2xl border border-jh-earth-200 p-5 shadow-jh-soft">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 text-center text-xs">
            <div className="p-3 bg-jh-earth-50 rounded-xl border border-jh-earth-200">
              <span className="font-bold text-jh-earth-800 block text-sm">
            ...
            <div className="p-3 bg-purple-50 rounded-xl border border-purple-200">
              <span className="font-bold text-purple-900 block text-sm">
                {issues.filter((i) => i.status === "IN_RD").length}
              </span>
            ...
            <div className="p-3 bg-amber-50 rounded-xl border border-amber-200">
              <span className="font-bold text-amber-900 block text-sm">
                {issues.filter((i) => i.status === "CSR_FUNDED").length}
              </span>
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold text-jh-green-950">
              Jharkhand State GIS Issue Map
            </h2>
            <p className="text-xs text-jh-earth-600">
              Explore reported environmental and civic complaints across all 24
              districts
            </p>
          </div>
          <Button
      ...
      <div className="bg-gradient-to-r from-jh-green-900 to-jh-green-800 rounded-3xl p-6 sm:p-8 text-white shadow-jh-soft flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative overflow-hidden">
        <div className="relative z-10 space-y-2">
          ...
          <p className="text-xs sm:text-sm text-jh-earth-200 max-w-xl">
            Your contributions help district nodal teams and university
            researchers restore Jharkhand's water bodies, forests, and civic
            infrastructure.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 space-y-4">
          ...
          {filteredIssues.length === 0 && (
            <div className="rounded-2xl border border-dashed border-jh-earth-300 bg-white p-8 text-center text-xs text-jh-earth-600">
        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          <div className="bg-jh-earth-100/70 rounded-2xl p-4 border border-jh-earth-200 text-xs space-y-2">
            ...
            <p className="text-jh-earth-700 leading-relaxed text-[11px]">
              Every citizen submission is verified on ground within 48 hours by
              the District Nodal Officer before routing to university R&D
              centers.
            </p>
          </div>
        </div>
