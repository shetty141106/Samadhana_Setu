    ...
    return (
      <div className="min-h-[85vh] flex items-center justify-center px-4 py-12 bg-jh-earth-100">
        <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl border border-jh-earth-200 p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-jh-green-950">
            Registration Complete
          </h2>
          <p className="mt-2 text-sm text-jh-earth-600">
            Your citizen account has been created. Sign in to continue to
            SamadhanSetu.
          </p>
          <Button
    ...
    <div className="min-h-[85vh] flex items-center justify-center px-4 py-12 relative overflow-hidden bg-jh-earth-100">
      ...
      <div className="relative z-10 w-full max-w-lg bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl border border-jh-earth-200 p-6 sm:p-8">
        <div className="mb-6">
          ...
          <h1 className="mt-5 text-2xl font-bold text-jh-green-950">
            Create Citizen Account
          </h1>
          <p className="mt-1 text-xs text-jh-earth-600">
            Register to report civic issues and track their resolution.
          </p>
        </div>
        {(localError || authError) && (
          <div
            role="alert"
            className="mb-4 flex items-start gap-2 rounded-xl border border-red-200 bg-red-50 px-3 py-2 text-xs text-red-800"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-[11px] font-bold uppercase tracking-wider text-jh-earth-800 mb-1.5">
              Full Name *
            </label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2.5 text-sm bg-jh-earth-50 border border-jh-earth-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-jh-green-700"
              />
            </div>
          </div>
          <div>
        ...
        <div className="mt-6 pt-5 border-t border-jh-earth-200 flex items-center justify-between text-xs">
          <button
            ...
            className="inline-flex items-center gap-1 text-jh-earth-600 hover:text-jh-green-900 hover:underline"
          >
          ...
          <button
            type="button"
            onClick={() => onNavigate("login")}
            className="font-semibold text-jh-green-800 hover:text-jh-terracotta-700 hover:underline"
          >
