...
export const Login = ({ onNavigate }) => {
  const { switchRole, login, authLoading, authError, isAuthenticated } =
    useAuth();
      ...
      <div className="relative z-10 max-w-4xl w-full grid grid-cols-1 md:grid-cols-12 gap-6 bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl border border-jh-earth-200 overflow-hidden">
        <div className="md:col-span-6 p-6 sm:p-8 bg-jh-earth-50/80 border-b md:border-b-0 md:border-r border-jh-earth-200 flex flex-col justify-between">
          <div>
            ...
            <p className="text-xs text-jh-earth-600 mb-5">
              Select the role associated with your account before signing in.
            </p>
              ...
              {Object.values(ROLES).map((roleKey) => {
                ...
                return (
                  <button
                    ...
                    className={`text-left p-2.5 rounded-2xl border transition-all flex items-start gap-2.5 group ${selected ? "border-jh-green-700 bg-jh-green-50 ring-2 ring-jh-green-700/20 shadow-jh-soft" : "border-jh-earth-200 bg-white hover:border-jh-green-700 hover:shadow-jh-soft"}`}
                  >
                    <div className="w-8 h-8 rounded-xl bg-jh-green-50 text-jh-green-900 flex items-center justify-center flex-shrink-0">
                      {selected ? (
                    ...
                    <div className="min-w-0">
                      <h4 className="text-xs font-bold text-jh-green-950 truncate">
                        {cfg.label}
                      </h4>
        ...
        <div className="md:col-span-6 p-6 sm:p-8 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-5">
              ...
              <button
                ...
                className="text-xs font-bold text-jh-green-800 hover:text-jh-terracotta-700"
              >
                New user? Register
              </button>
            </div>
            {(localError || authError) && (
              <div
                role="alert"
                className="mb-3 flex items-start gap-2 rounded-xl border border-red-200 bg-red-50 px-3 py-2 text-xs text-red-800"
              >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    autoComplete="email"
                    className="w-full pl-9 pr-3 py-2.5 text-xs bg-jh-earth-50 border border-jh-earth-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-jh-green-700"
                  />
                </div>
              </div>
              <div>
            ...
            {!selectedRole && (
              <p className="mt-4 text-center text-[11px] text-jh-earth-500">
          ...
          <button
            ...
            className="pt-6 text-xs text-jh-earth-600 hover:text-jh-green-900 hover:underline"
          >
