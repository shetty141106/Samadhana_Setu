...
const icons = {
  ...
  report: (
    <>
      <path d="M8 3h8l3 4v13a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1Z" />
  ...
  queue: (
    <>
      ...
      <rect x="3.5" y="15.5" width="10" height="4" rx="1" />
    </>
  ),
  heat: (
    <>
      <path d="M12 3c2.5 3 4 5.4 4 8a4 4 0 1 1-8 0c0-1 .3-1.9.8-2.7" />
      <path d="M12 12.5c1 1 1.6 1.9 1.6 3a1.6 1.6 0 1 1-3.2 0c0-.6.2-1 .5-1.5" />
    </>
  ),
  assign: (
    <>
  ...
  team: (
    <>
      ...
      <path d="M3.5 19c.7-3 3-4.7 5.5-4.7s4.8 1.7 5.5 4.7M15 19c.4-2 1.7-3.3 3.4-3.6" />
    </>
  ),
  mentor: (
    <>
      <path d="M12 3 3 7.5 12 12l9-4.5L12 3Z" />
      <path d="M6.5 10v4.5c0 1.3 2.5 2.5 5.5 2.5s5.5-1.2 5.5-2.5V10" />
    </>
  ),
  milestone: (
    <>
  ...
  users: (
    <>
      ...
      <path d="M2.5 19c.6-3.3 2.7-5 5.5-5s5 1.8 5.5 5" />
      <path d="M14.5 15.2c2.3.3 3.7 1.8 4.2 3.8" />
    </>
  ),
  overview: (
    <>
  ...
  settings: (
    <>
      ...
      <path d="M19.4 13.5a7.6 7.6 0 0 0 0-3l2-1.4-2-3.4-2.3.8a7.7 7.7 0 0 0-2.6-1.5L14 2.5h-4l-.5 2.5a7.7 7.7 0 0 0-2.6 1.5l-2.3-.8-2 3.4 2 1.4a7.6 7.6 0 0 0 0 3l-2 1.4 2 3.4 2.3-.8c.8.7 1.7 1.2 2.6 1.5l.5 2.5h4l.5-2.5a7.7 7.7 0 0 0 2.6-1.5l2.3.8 2-3.4-2-1.4Z" />
    </>
  ),
  bell: (
    <>
      ...
      <div className="relative hidden lg:block overflow-hidden">
        ...
        <div className="relative z-10 flex h-full flex-col justify-between p-12 xl:p-16">
          <div className="flex items-center gap-3">
            <div className="grid h-10 w-10 place-items-center rounded-xl bg-jh-gold-500/90 text-jh-green-900 font-heading font-bold">
              JH
            </div>
            <span className="text-jh-earth-50 font-heading font-semibold tracking-tight">
              Jharkhand Digital Commons
            </span>
          </div>

          <div className="max-w-md">
            <p className="text-jh-gold-400 font-heading text-sm font-medium mb-3">
              Civic reporting · Student R&amp;D · Public–industry partnership
            </p>
            <h1 className="font-serif italic text-jh-earth-50 text-4xl xl:text-5xl leading-[1.15]">
              ...
              <span className="not-italic font-sans font-semibold text-jh-terracotta-300">
                {" "}
                branching to every role.
              </span>
            </h1>
          </div>

          <p className="text-jh-earth-200/80 text-sm max-w-sm">
            Six roles, one AppShell — the sidebar and workspace change under
            you, the ground stays the same.
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-6 sm:p-10">
        <form onSubmit={submit} className="w-full max-w-md">
          <div className="lg:hidden mb-8 flex items-center gap-3">
            <div className="grid h-9 w-9 place-items-center rounded-lg bg-jh-green-900 text-jh-gold-400 font-heading font-bold text-sm">
              JH
            </div>
            <span className="text-jh-green-900 font-heading font-semibold">
              Jharkhand Digital Commons
            </span>
          </div>

          <h2 className="font-heading text-2xl font-semibold text-jh-green-900">
            Sign in to continue
          </h2>
          <p className="text-jh-earth-600 text-sm mt-1.5 mb-6">
            Choose the role your account was registered under.
          </p>
            ...
            {ROLES.map((r) => {
              ...
              return (
                ...
                >
                  <span
                    className={
                      active ? "text-jh-gold-400" : "text-jh-green-700"
                    }
                  >
                  ...
                  <div
                    className={
                      ...
                      (active ? "text-jh-earth-200/80" : "text-jh-earth-500")
                    }
                  >
                    {r.blurb}
                  </div>
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-medium text-jh-earth-600 mb-1.5">
                Username
              </label>
              <input
                defaultValue={role ? `${role.id}.demo` : ""}
                className="w-full rounded-lg border border-jh-earth-200 px-3 py-2 text-sm text-jh-earth-800 outline-none focus:border-jh-green-600 focus:ring-2 focus:ring-jh-green-100"
              />
            </div>
            <div>
              <label className="block text-xs font-medium text-jh-earth-600 mb-1.5">
          ...
          <button
            ref={btnRef}
            type="submit"
            disabled={!roleId || phase === "authenticating"}
          ...
          <p className="text-center text-[11px] text-jh-earth-400 mt-3">
            JWT is issued, stored, and AuthContext updated on success.
          </p>
        </form>
      </div>
    </div>
  ...
  return (
    <header className="animate-drop-in sticky top-0 z-30 flex items-center justify-between h-16 px-4 sm:px-6 bg-jh-earth-50/90 backdrop-blur border-b border-jh-earth-200">
      <div className="flex items-center gap-3">
        <button
          onClick={onMenu}
          className="lg:hidden grid h-9 w-9 place-items-center rounded-lg text-jh-green-800 hover:bg-jh-green-50"
        >
          {I("menu", "w-5 h-5")}
        </button>
        <div className="hidden sm:flex items-center gap-2.5">
          <div className="grid h-8 w-8 place-items-center rounded-lg bg-jh-green-900 text-jh-gold-400 font-heading font-bold text-xs">
            JH
          </div>
          <span className="font-heading text-sm font-semibold text-jh-green-900">
            {role.dash}
          </span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-1.5 sm:gap-3">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 rounded-lg pl-1 pr-2 py-1 hover:bg-jh-earth-200/60 transition-colors"
          >
            <img
              src={img(role.id + "-avatar", 80, 80)}
              alt=""
              className="h-8 w-8 rounded-full object-cover ring-2 ring-jh-gold-400/60"
            />
            <span className="hidden sm:block text-sm font-medium text-jh-earth-800">
              {role.label} Demo
            </span>
            {I(
              "chevron",
              "w-4 h-4 hidden sm:block rotate-90 text-jh-earth-400",
            )}
          </button>
          {profileOpen && (
            <div className="animate-rise-in absolute right-0 mt-2 w-48 rounded-xl border border-jh-earth-200 bg-white p-1.5 shadow-jh-card">
              <button className="w-full text-left px-3 py-2 rounded-lg text-sm text-jh-earth-700 hover:bg-jh-earth-100">
                Profile settings
              </button>
              <button
                onClick={onLogout}
                className="w-full flex items-center gap-2 text-left px-3 py-2 rounded-lg text-sm text-jh-terracotta-700 hover:bg-jh-terracotta-50"
              >
  ...
  const content = (
    <div className="flex h-full flex-col bg-green-gradient text-jh-earth-100">
      <div className="flex items-center justify-between px-5 h-16 border-b border-white/10">
        <span className="font-heading text-sm font-semibold text-jh-earth-50">
          {role.label} Menu
        </span>
        <button
          onClick={onClose}
          className="lg:hidden text-jh-earth-200 hover:text-white"
        >
          {I("x", "w-5 h-5")}
        </button>
      </div>
        ...
        {role.nav.map((item, i) => {
          ...
          return (
            ...
            >
              <span
                className={
                  isActive ? "text-jh-terracotta-600" : "text-jh-gold-400/90"
                }
              >
                {I(item.icon, "w-[18px] h-[18px]")}
              </span>
              {item.label}
            </button>
          );
      ...
      <div className="p-4 mx-3 mb-4 rounded-xl bg-white/10 text-xs text-jh-earth-100/85">
        <p className="font-heading font-semibold text-jh-gold-400 mb-1">
          Rooted in every district
        </p>
    ...
    <>
      ...
      {mobileOpen && (
        <div className="lg:hidden fixed inset-0 z-40">
          <div
            className="absolute inset-0 bg-jh-charcoal/60 backdrop-blur-sm"
            onClick={onClose}
          />
    ...
    <div className="animate-rise-in max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
      ...
      <div className="relative overflow-hidden rounded-2xl h-44 sm:h-56">
        ...
        <div className="relative z-10 h-full flex flex-col justify-end p-5 sm:p-7">
          <p className="text-jh-gold-400 text-xs font-heading font-semibold tracking-wide">
            {role.label.toUpperCase()} · LIVE
          </p>
          <h1 className="font-heading text-2xl sm:text-3xl font-bold text-jh-earth-50 mt-1">
            {role.hero}
          </h1>
      ...
      <div className="grid lg:grid-cols-[1.4fr_1fr] gap-4 mt-4">
        <div className="rounded-2xl border border-jh-earth-200 bg-white p-5">
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-heading font-semibold text-jh-earth-800">
              Recent activity
            </h2>
            <button className="text-xs font-medium text-jh-green-700 hover:text-jh-green-900">
              View all
            </button>
          </div>
          <ul className="space-y-3">
            {[
              "Pothole near Sadar Hospital verified",
              "Milestone 2 approved for Project Mahua",
              "New sponsorship confirmed — ₹2.4L",
            ].map((t, i) => (
              <li key={i} className="flex items-start gap-3 text-sm">
                ...
                <span className="ml-auto text-xs text-jh-earth-400 shrink-0">
                  {i + 1}h ago
                </span>
              </li>
            ))}
        ...
        <div className="rounded-2xl bg-terracotta-gradient p-5 text-jh-earth-50 flex flex-col justify-between overflow-hidden relative">
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm text-jh-earth-50/90 mt-1.5">
              {role.id === "citizen" &&
                "Spotted something in your area? File it in under two minutes."}
              {role.id === "nodal" &&
                "4 issues are past SLA — clear the queue today."}
              {role.id === "student" &&
                "Your next milestone review opens Friday."}
              {role.id === "faculty" &&
                "2 milestone submissions are awaiting your review."}
              {role.id === "industry" &&
                "3 new projects match your CSR focus areas."}
...
export default function JharkhandAppShell() {
  ...
  return (
    <div
      className="min-h-screen bg-jh-earth-100 font-sans"
      style={{
        "--origin-x": `${wash?.x ?? 0}px`,
        "--origin-y": `${wash?.y ?? 0}px`,
      }}
    >
